...
feature 'Admin edits car model' do
  ...
  scenario 'and name must be unique' do
    ...
    car_model_1 = CarModel.create!(name: 'Uno', year: '2018', motorization: '1.5', fuel_type: 'Flex', car_category: car_category_a, manufacturer: manufacturer_fiat)
    CarModel.create!(name: 'Fit', year: '2018', motorization: '1.5', fuel_type: 'Flex', car_category: car_category_b, manufacturer: manufacturer_honda)
    user = User.create!(email: 'test#@test.com', password: '123456')
