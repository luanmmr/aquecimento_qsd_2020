...
car_model_4 = CarModel.create!(name: 'Punto', year: '2012', motorization: '2.0', fuel_type: 'Flex', car_category: car_category, manufacturer: manufacturer)
car_model_5 = CarModel.create!(name: 'Fusion', year: '2018', motorization: '2.0', fuel_type: 'Flex', car_category: car_category_2, manufacturer: manufacturer_2)
car_model_6 = CarModel.create!(name: 'Fit', year: '2018', motorization: '2.0', fuel_type: 'Flex', car_category: car_category_3, manufacturer: manufacturer_3)
...
Car.create!(license_plate: 'KTY4212', color: 'Preto', car_model: car_model_3, mileage: 10.00, subsidiary: subsidiary_3)
Car.create!(license_plate: 'UML6111', color: 'Roxo', car_model: car_model_4, mileage: 10.00, subsidiary: subsidiary)
...
Rental.create!(code: 'XFB0000', start_date: Time.zone.today, end_date: 1.day.from_now, client: client, car_category: car_category, user: user)
Rental.create!(code: 'XFB0001', start_date: Time.zone.today, end_date: 3.day.from_now, client: client_2, car_category: car_category_2, user: user_2)
Rental.create!(code: 'XFB0002', start_date: Time.zone.today, end_date: 6.day.from_now, client: client_3, car_category: car_category_3, user: user_3)
