...
car_model_5 = CarModel.create!(name: 'Fusion', year: '2018', motorization: '2.0', fuel_type: 'Flex', car_category: car_category_3, manufacturer: manufacturer_2)
car_model_6 = CarModel.create!(name: 'Fit', year: '2018', motorization: '2.0', fuel_type: 'Flex', car_category: car_category_2, manufacturer: manufacturer_3)
